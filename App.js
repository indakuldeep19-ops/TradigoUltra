      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          tabBarIcon: ({ color, size, focused }) => {
            ...
            else if (route.name === 'CopyTrade') iconName = focused ? 'people' : 'people-outline';
            else if (route.name === 'CreateRoom') iconName = focused ? 'add-circle' : 'add-circle-outline';
            else if (route.name === 'Subscribe') iconName = focused ? 'card' : 'card-outline';
